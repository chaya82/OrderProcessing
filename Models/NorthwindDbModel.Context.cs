...
namespace OrderProcessing.Models
{
    ...
    public partial class DbModels : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> SP_GetTotalSales(string city, Nullable<int> year, Nullable<int> product)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("SP_GetTotalSales", cityParameter, yearParameter, productParameter);
        }
    }
}
